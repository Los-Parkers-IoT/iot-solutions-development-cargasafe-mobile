...
class MainDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // ✅ Forma compatible con go_router reciente
    // matchedLocation es la ruta "resuelta" sin query; uri incluye query.
    final state = GoRouterState.of(context);
    final current = state.matchedLocation.isNotEmpty
        ? state.matchedLocation
        : state.uri.toString(); // p.ej. "/dashboard"
              ...
              child: ListView(
                ...
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text('Fleet', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 12)),
                  ),
                  _Section(children: [
                    _NavItem(
...
class _Section extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Column(
    children: children
        .map((w) => Padding(padding: const EdgeInsets.symmetric(horizontal: 8), child: w))
        .toList(),
  );
}
...
class _BottomDivider extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) =>
      const Padding(padding: EdgeInsets.symmetric(vertical: 6), child: Divider(height: 1, indent: 16, endIndent: 16));
}
