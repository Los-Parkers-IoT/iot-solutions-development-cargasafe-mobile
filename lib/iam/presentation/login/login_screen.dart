          ...
          child: Form( // Envolver en Form
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  height: 48,
                  child: TextFormField( // Cambiar TextField a TextFormField
                    controller: _emailController,
                    validator: Validators.validateEmail, // Agregar validación
                    ...
                    decoration: InputDecoration(
                      ...
                      errorBorder: OutlineInputBorder( // Agregar borde de error
                        borderRadius: BorderRadius.circular(6),
                      ...
                      isDense: true,
                      errorStyle: TextStyle(fontSize: 11), // Estilo del mensaje de error
                    ),
                  ),
                ),
                SizedBox(height: 20),
                ...
                Container(
                  ...
                  child: TextFormField( // Cambiar TextField a TextFormField
                    ...
                    obscureText: true,
                    validator: Validators.validatePassword, // Agregar validación
                    decoration: InputDecoration(
                      border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(6),
                        borderSide: BorderSide(color: Colors.grey[400]!),
